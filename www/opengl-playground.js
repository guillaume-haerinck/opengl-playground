...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'bin/opengl-playground.data';
    var REMOTE_PACKAGE_BASE = 'opengl-playground.data';
...
Module['FS_createPath']('/res/shaders/basics', 'rotating-cube', true, true);
Module['FS_createPath']('/res/shaders/basics', 'basic-triangle', true, true);
        ...
        DataRequest.prototype.byteArray = Module['HEAPU8'].subarray(ptr, ptr+byteArray.length);
          ...
          for (var i = 0; i < files.length; ++i) {
            DataRequest.prototype.requests[files[i].filename].onload();
              ...
              Module['removeRunDependency']('datafile_bin/opengl-playground.data');

    };
    Module['addRunDependency']('datafile_bin/opengl-playground.data');
 ...
 loadPackage({"files": [{"start": 0, "audio": 0, "end": 117, "filename": "/res/shaders/basics/rotating-cube/rotating-cube.vert"}, {"start": 117, "audio": 0, "end": 295, "filename": "/res/shaders/basics/rotating-cube/rotating-cube.frag"}, {"start": 295, "audio": 0, "end": 401, "filename": "/res/shaders/basics/basic-triangle/basic-triangle.frag"}, {"start": 401, "audio": 0, "end": 518, "filename": "/res/shaders/basics/basic-triangle/basic-triangle.vert"}], "remote_package_size": 518, "package_uuid": "07b19594-90e5-4a47-8ffb-56b29242cf34"});
...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 5347248,
    DYNAMIC_BASE = 5347248,
    DYNAMICTOP_PTR = 104112;
...
var wasmBinaryFile = 'opengl-playground.wasm';
...
// {{PRE_LIBRARY}}
  ...
  var _stderr=104160;var FS={root:null,mounts:[],devices:{},streams:[],nextInode:1,nameTable:null,currentPath:"/",initialized:false,ignorePermissions:true,trackingDelegate:{},tracking:{openFlags:{READ:1,WRITE:2}},ErrnoError:null,genericErrors:{},filesystems:null,syncFSRequests:0,handleFSError:function(e) {
  ...
  var ___tm_timezone=(stringToUTF8("GMT", 104256, 4), 104256);function _gmtime_r(time, tmPtr) {
