...
Module['FS_createPath']('/', 'res', true, true);
 ...
 loadPackage({"files": [{"start": 0, "audio": 0, "end": 16, "filename": "/res/test.txt"}], "remote_package_size": 16, "package_uuid": "69c23c0b-435e-4c2e-bd82-bb057ec87060"});
...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 5330368,
    DYNAMIC_BASE = 5330368,
    DYNAMICTOP_PTR = 87232;
...
// {{PRE_LIBRARY}}
  ...
  var _stderr=87280;var FS={root:null,mounts:[],devices:{},streams:[],nextInode:1,nameTable:null,currentPath:"/",initialized:false,ignorePermissions:true,trackingDelegate:{},tracking:{openFlags:{READ:1,WRITE:2}},ErrnoError:null,genericErrors:{},filesystems:null,syncFSRequests:0,handleFSError:function(e) {
  ...
  var ___tm_timezone=(stringToUTF8("GMT", 87376, 4), 87376);function _gmtime_r(time, tmPtr) {
